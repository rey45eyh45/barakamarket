...
export function EditProductForm({ product, onClose, onSubmit }: EditProductFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const updatedProduct: Product = {
      ...
      image: images.filter(img => img).find(img => img) || product.image,
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="sticky top-0 bg-gradient-to-r from-green-600 to-teal-600 text-white px-6 py-4 flex items-center justify-between z-10 shadow-lg">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
              <Package className="w-6 h-6" />
            </div>
            <div>
              <h2 className="text-white font-bold">Mahsulotni tahrirlash</h2>
              <p className="text-green-100 text-sm">Ma'lumotlarni yangilang</p>
            </div>
          </div>
          <IconButton
            icon={<X />}
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
          <div className="space-y-6">
            ...
            <Card variant="outlined" padding="lg">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-gray-900 font-semibold">Asosiy ma'lumotlar</h3>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:outline-none text-gray-900 transition"
                    required
                  >
                    {categories.map(cat => (
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 border-2 border-gray-200 rounded-lg focus:border-blue-500 focus:outline-none text-gray-900 min-h-[120px] transition resize-none"
            ...
            <Card variant="outlined" padding="lg">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-gray-900 font-semibold">Narx va chegirma</h3>
              </div>
            ...
            <Card variant="outlined" padding="lg">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-gray-900 font-semibold">Ombor</h3>
              </div>
            ...
            <Card variant="outlined" padding="lg">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-gray-900 font-semibold">Kafolat va qaytarish</h3>
              </div>
            ...
            <Card variant="outlined" padding="lg">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 className="text-gray-900 font-semibold">Rasmlar</h3>
              </div>
            ...
            <Card variant="outlined" padding="lg">
              <button
                ...
                className="w-full flex items-center justify-between text-gray-900 font-semibold mb-4"
              >
          ...
          {/* Actions */}
          <div className="sticky bottom-0 bg-white pt-6 pb-2 mt-6 border-t flex gap-3">
            <Button
              type="button"
              variant="secondary"
              size="lg"
